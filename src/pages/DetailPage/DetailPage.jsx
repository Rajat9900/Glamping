  ...
  return (
    ...
    <div className={styles.photoGrid}>
      ...
      <div className={` ${styles.showAll}`}>
        <button> <img src={groupIcon}/>Show all photos</button>
      </div>
    </div>
    </div>
...
<div className={styles.thirdDivCont}>
  ...
  <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nobis deleniti cumque et accusamus adipisci minima, impedit maiores aperiam sed beatae asperiores tempora similique <br/>assumenda, corporis molestias dolorum aliquid vel. Quos!</p>
  <Link to='' className={styles.linkDivThird}>Show more <MdKeyboardArrowRight/></Link>
</div>
...
<div className={styles.fifthDivCont}>
  ...
  <div className={styles.firthdivBtn}>
   <img src={groupIcon}/>Show all amenities
  </div>
</div>
</div>
