...
const SignUpModal = ({ show, onClose, onLoginSuccess, onSignUpSuccess ,onSwitchToLogin}) => {
    ...
    onSuccess: async (response) => {
      try {
        ...
        if (backendRes.data.redirect === "mainHomepage") {
          ...
          localStorage.setItem( "userInfo",JSON.stringify(backendRes.data.creatuser) );
  ...
  const onSubmit = async (data) => {
    ...
    if (emailSignupRes.data.redirect === "loginPage") {
      ...
      localStorage.setItem( "userInfo", JSON.stringify(emailSignupRes.data.newUser) );
      toast.success(emailSignupRes.data.message);
      onSignUpSuccess(true);
    }
  };
