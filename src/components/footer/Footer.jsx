...
import likedinicon from '../../../public/likedinicon.svg'
    ...
    <div className={styles.footerMainDiv}>
      ...
      <div className={styles.ContentFooter}>
        <div className={styles.leftSideContent}>
          ...
          <div>
            <img src={fbicon} className={styles.iconBtn} />
            <img src={likedinicon} className={styles.iconBtn} />
            <img src={instaicon} className={styles.iconBtn} />
          </div>
        </div>
