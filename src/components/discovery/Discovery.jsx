...
const Discovery = () => {
   const amentyContent = [
      {image: amentyIcon1 , head: "Enhanced Comfort" , para: "Revel in a heightened level of comfort during your Glamping escapade."},
      {image: amentyIcon2 , head: "Breathtaking Views" , para: "Immerse yourself in the awe-inspiring vistas that surround your Glamping retreat."},
      {image: amentyIcon3 , head: "Glamping Pros" , para: "Discover the advantages & expertise that Glamping professionals bring to your journey."},
      {image: amentyIcon4 , head: "Variety of Tent Options" , para: "Spacious family tents to intimate, there  a perfect shelter for every adventurer."},
      {image: amentyIcon5 , head: "Delicious Dining" , para: "Delight your palate with delectable dining options curated specifically for your experience."},
      {image: amentyIcon6 , head: "Nature's Serenity" , para: "Welcoming peace and soothing sounds for ultimate relaxation and inner peace."},
   ]
   const discoverContent =[
      {img: discoverImage1, rating: 4.3 , star1: star , head:"Ankoret Lac Camp & Party, Da Lat, Vietnam",para:"Mall Road Shimla Hignway", rupees:"$100", perNight:"/night", location: <GrLocation/>},
      {img: discoverImage2, rating: 4.1 , star1: star , head:"Ankoret Lac Camp & Party, Da Lat, Vietnam",para:"Mall Road Shimla Hignway", rupees:"$100", perNight:"/night", location: <GrLocation/>},
      {img: discoverImage3, rating: 4.7 , star1: star , head:"Ankoret Lac Camp & Party, Da Lat, Vietnam",para:"Mall Road Shimla Hignway", rupees:"$100", perNight:"/night", location: <GrLocation/>}
   ]
...
<div className={styles.CardCarouselContent}>
   {discoverContent.map((discoverCont) => {
      return(
         <>
         <Card  className={styles.CardContentDiv} onClick={navigateToListingPage}>
      <Card.Img variant="top"  src={discoverCont.img} className={styles.ImgCarousel}/>
      <p className={styles.startRatiingdiv}>{discoverCont.rating}<span><img src={discoverCont.star1}/></span></p>
      <div className={styles.cardContent}>
        <div>{discoverCont.head}</div>
        <p>
        <GrLocation/> {discoverCont.para}
        </p>
        <h4>{discoverCont.rupees}<span>{discoverCont.perNight}</span></h4>
      </div>
    </Card>
         </>
      )
